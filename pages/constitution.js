      ...
      <div className="container is-widescreen">
        ...
        <div className="container narrow">
          <section className="section content">
            ...
            <p>
              3.2. To be an inclusive community junior cricket club with a goal
              of catering for all junior players wanting to play competitive
              cricket.
            </p>
            ...
            <p>
              ...
              membership of the Club. The Committee and any sub-committee will
              be made up of volunteers, no remuneration will be paid to these
              positions.
            </p>
            ...
            <p>
              ...
              books of accounts for auditing once seasonally before the Clubs
              AGM, with an unaudited review mid season and shall cause the
              preparation of a financial statement for presentation to the
            ...
            <p>
              15.3. No member shall be allowed to vote at any meeting of the
            ...
            <p>
              ...
              donated to any registered charity or organisation chosen by the
              last elected Committee members of the Somerset Strikers Cricket
              Club.
            </p>
            ...
            <p className="has-text-centered">
              ...
              Chairperson), Fiona Haughney (Honorary Secretary), Leonard Willemse
              (Honorary Treasurer), Jimmy Sounes (Club Captain)
            </p>
          </section>
        </div>
      </div>
