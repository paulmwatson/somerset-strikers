    ...
    <React.Fragment>
      ...
      <div className="container narrow">
        <section className="section content">
          ...
          <p>
            Paid-up players will be selected first, secondly by players who
            have attended the greatest number of practices, and thirdly players
            who regularly make themselves available for matches. Regular
          ...
          <p>
            ...
            Additional overs can be given to the best performing bowlers on the
            day. Retired batters will return to batting in the order they went
            into bat.
          </p>
          ...
          <h2 className="title">Current Age Groups</h2>
          <h3 className="title">U10</h3>
          <p>All U10 teams will be rotation based.</p>
          <h3 className="title">U11</h3>
          <p>All U11 teams will be role based.</p>
