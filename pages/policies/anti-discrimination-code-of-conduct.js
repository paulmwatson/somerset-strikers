      ...
      <div className="container is-widescreen">
        ...
        <div className="container narrow">
          <section className="section">
            ...
            <p className="content">
              Other people these codes and policies apply to are players,
              members, parents, guardians, and supporters.
            </p>
            <p className="content">
              The codes, policies, and guidelines of the organisation hosting an
              event may supersede these. Please make an effort to be aware of
              your host.
            </p>
            <ol className="content">
              ...
              <li>
                All volunteers will respect the privacy and time of other
                people.
              </li>
              <li>
                Volunteers are mostly untrained and are learning too. Be
              ...
              <li>
                There may be gender rules but inappropriate gender
              ...
              <li>
                Ability may be a factor in selection but inappropriate
                disability discrimination will not be tolerated.
              </li>
              <li>
              ...
              <li>
                Volunteers should ensure all children are accounted for and in
                the care of an adult before leaving an event.
              </li>
              <li>
            ...
            <p className="content">
              Disputes to codes and policies will be handled by the Committee in
