      ...
      <div className="container is-widescreen">
        ...
        <div className="container narrow">
          <section className="section content">
            ...
            <p className="mark-changed">
              Inline changes are indicated in <strike>red</strike> and{" "}
              <strong>green</strong>
            </p>
            ...
            <p className="mark-changed">
              <strike>3.1.</strike> <strong>3.1.1.</strong>{" "}
              <strike>To promote</strike> <strong>Promoting</strong> the
              development of junior cricket in the Somerset West area by
              creating a safe, constructive, and competitive environment in
              which children can develop as cricketers, and people, with the
              assistance of committed and responsible parents.
            </p>
            <p className="mark-changed">
              <strike>3.2.</strike> <strong>3.1.2.</strong>{" "}
              <strike>To be</strike> <strong>Being</strong> an inclusive
              community junior cricket club with a goal of catering for all
              junior players wanting to play competitive cricket.
            </p>
            <p className="mark-new">
            ...
            <p className="mark-changed">
              <strong>4.1.</strong> The management, control and administration
              of all matters and affairs of the Club shall be vested in a
              controlling body, hereafter referred to as the Committee and which
            ...
            <p className="mark-changed">
              <strong>4.2.</strong> The Committee shall have the power to
              accept, refuse<strong>,</strong> and cancel membership in the
              Club. The Committee and any <strike>sub-committee</strike>{" "}
              <strong>subcommittee</strong> will be made up of volunteers
              <strike>,</strike> <strong>;</strong> no remuneration will be paid
              to these positions.
            </p>
            <p className="mark-new">
              4.3. All Committee members must be natural persons.
            </p>
            <p className="mark-new">
            ...
            <p className="mark-changed">
              ...
              <strong>
                and shall be entitled to annual or seasonal membership
              </strong>
              .
            </p>
            <p>
            ...
            <p className="mark-changed">
              <strike>15.3.</strike> <strong>15.4.</strong> No member shall be
              allowed to vote at any meeting of the Club unless they are a fully
              paid up member.
            </p>
            <p className="mark-changed">
              <strike>15.4.</strike> <strong>15.5.</strong> Details of the
              Election of Committee Members process is published separately.
            </p>
            <h2 className="title">
            ...
            <h2 className="title mark-new">21. PROHIBITION OF DISTRIBUTIONS</h2>
            <p className="mark-new">
            ...
            <h2 className="title mark-changed">
              <strike>20.</strike> <strong>22.</strong> CLOSURE OF SOMERSET
              STRIKERS CRICKET CLUB
            </h2>
            <p className="mark-changed">
              <strong>22.1.</strong> Should the Club cease to exist then all
              monies and assets shall be donated to any registered charity or
              organisation chosen by the last elected Committee members of the
              Somerset Strikers Cricket Club.
            </p>
            <p className="mark-new">
            ...
            <h2 className="title mark-changed">
              <strike>21.</strike> <strong>23.</strong> ADOPTION OF THE
            ...
            <h2 className="title mark-changed">
              <strike>22.</strike> <strong>24.</strong> OUR MISSION STATEMENT
            </h2>
            <p>
            ...
            <h2 className="title mark-new">25. FURTHER UNDERTAKINGS</h2>
            <p className="mark-new">
            ...
            <p className="has-text-centered">
              Committee: Wesley Moodie (Chairperson), Paul Watson (Vice
              Chairperson), Fiona Haughney (Honorary Secretary), Leonard
              Willemse (Honorary Treasurer), Jimmy Sounes (Club Captain)
            </p>
          </section>
        </div>
      </div>
